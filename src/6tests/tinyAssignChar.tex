...
\node[vertexr] (G10x2) at (10,-2) {Call outputc};
...
\node[vertexr] (G15x3) at (15,-3) {'c'};
\draw[drawstyle] (G14x2) -- (G15x3);
\node[vertexr] (G16x2) at (16,-2) {Call outputc};
...
\node[vertexr] (G18x3) at (18,-3) {'d'};
\draw[drawstyle] (G17x2) -- (G18x3);
\node[vertexr] (G19x2) at (19,-2) {Call outputc};
...
\node[vertexr] (G22x3) at (22,-3) {'e'};
\draw[drawstyle] (G21x2) -- (G22x3);
\node[vertexr] (G23x2) at (23,-2) {Call outputc};
...
\node[vertexr] (G25x3) at (25,-3) {'f'};
\draw[drawstyle] (G24x2) -- (G25x3);
\node[vertexr] (G26x2) at (26,-2) {Call outputc};
...
\node[vertexr] (G28x3) at (28,-3) {'f'};
\draw[drawstyle] (G27x2) -- (G28x3);
\node[vertexr] (G29x2) at (29,-2) {Call outputc};
...
\node[vertexr] (G31x3) at (31,-3) {'h'};
\draw[drawstyle] (G30x2) -- (G31x3);
\node[vertexr] (G32x2) at (32,-2) {Call outputc};
...
\node[vertexr] (G35x2) at (35,-2) {char zx};
\node[vertexr] (G36x2) at (36,-2) {char zy};
