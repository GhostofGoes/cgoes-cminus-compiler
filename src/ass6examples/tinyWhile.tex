...
\node[vertexr] (G4x2) at (4,-2) {While};
\node[vertexr] (G4x3) at (4,-3) {$>$};
\node[vertexr] (G4x4) at (4,-4) {x};
\draw[drawstyle] (G4x3) -- (G4x4);
\node[vertexr] (G5x4) at (5,-4) {10};
\draw[drawstyle] (G4x3) -- (G5x4);
\draw[drawstyle] (G4x2) -- (G4x3);
\node[vertexr] (G6x3) at (6,-3) {++};
\node[vertexr] (G6x4) at (6,-4) {x};
\draw[drawstyle] (G6x3) -- (G6x4);
\draw[drawstyle] (G4x2) -- (G6x3);
